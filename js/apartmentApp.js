...
var $table = document.querySelector("#apartment-table");
var $loader = document.querySelector(".loader");
var $pagination = document.querySelector(".pagination");
var $tbody = document.getElementsByTagName("tbody")[0];
var $rentTypeSearch = document.querySelector("#rentType-search");
...
var filterOptions = {
  ...
  country: function() {
    return $rentTypeSearch.value.trim();
  },
  shape: function() {
...
function loadDropdown() {
  ...
  // Render the arrays of country and shape HTML option tags to the rentTypeSearch select box on the page
  $rentTypeSearch.innerHTML = dropdownOptions.country.join("");
